...
/**
 * TaxiTripHistory entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "taxi_trip_history", catalog = "ecarride_db_foreign_key")

public class TaxiTripHistory implements java.io.Serializable {
	...
	/** default constructor */
	public TaxiTripHistory() {
	}

	/** full constructor */
	public TaxiTripHistory(Integer baseId, Integer companyId, Integer userId, Integer driverId, Integer tripType,
			Integer notifyDriverId, Integer scriptStatus, String pickupLat, String pickupLng, String pickupLocation,
			String destinationLat, String destinationLng, String destinationLocation, Integer pet, Integer wheelchair,
			Integer walkingAid, Float estimateTime, Float estimateLowFare, Float estimateHighFare,
			Float estimateHighFareOrigin, Float negotiatedPrice, Timestamp acceptanceTime, Float baseFare,
			Float distanceFare, Float minuteFare, Float tripFare, Float tripFareOrigin, Float gasSurcharge,
			Float tollFee, Float blackCarFund, Float tax, Float tip, Float signupDiscount, Float couponDiscount,
			String couponCode, Float adjustment, Float totalAmount, Float dspShare, Float baseShare, Float driverShare,
			String comments, Timestamp commentsTime, Integer commentsType, String cancelAddress, Integer favorite,
			Integer tripStatus, Integer payStatus, Timestamp arrivalTime, String realPickupLocation,
			Timestamp startTime, String realStartLocation, Timestamp endTime, Float distance, String endDestination,
			String userSignature, Timestamp createdAt, Timestamp updatedAt, Integer status) {
		this.baseId = baseId;
