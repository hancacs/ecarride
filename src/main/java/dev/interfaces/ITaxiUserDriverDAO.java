...
/**
 * Interface for TaxiUserDriverDAO.
 * 
 * @author MyEclipse Persistence Tools
 */

public interface ITaxiUserDriverDAO {
	/**
	 ...
	 * ITaxiUserDriverDAO.save(entity);
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * ITaxiUserDriverDAO.delete(entity);
	 * EntityManagerHelper.commit();
	 * entity = null;
	 * </pre>
	 * 
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * entity = ITaxiUserDriverDAO.update(entity);
	 * EntityManagerHelper.commit();
	 * </pre>
	 * 
	 * @param entity
	 ...
	 */
	public List<TaxiUserDriver> findByProperty(String propertyName, Object value, int... rowStartIdxAndCount);
	 ...
	 */
	public List<TaxiUserDriver> findAll(int... rowStartIdxAndCount);
}