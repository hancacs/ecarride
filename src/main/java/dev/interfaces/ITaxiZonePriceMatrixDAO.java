...
/**
 * Interface for TaxiZonePriceMatrixDAO.
 * 
 * @author MyEclipse Persistence Tools
 */

public interface ITaxiZonePriceMatrixDAO {
	/**
	 ...
	 * ITaxiZonePriceMatrixDAO.save(entity);
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * ITaxiZonePriceMatrixDAO.delete(entity);
	 * EntityManagerHelper.commit();
	 * entity = null;
	 * </pre>
	 * 
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * entity = ITaxiZonePriceMatrixDAO.update(entity);
	 * EntityManagerHelper.commit();
	 * </pre>
	 * 
	 * @param entity
	 ...
	 */
	public List<TaxiZonePriceMatrix> findByProperty(String propertyName, Object value, int... rowStartIdxAndCount);
	 ...
	 */
	public List<TaxiZonePriceMatrix> findAll(int... rowStartIdxAndCount);
}